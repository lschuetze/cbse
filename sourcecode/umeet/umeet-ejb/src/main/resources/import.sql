...
insert into Appointment(id, endDate, notes, personal, startDate, status, title, creator_email) values (4711, 512, 'testnotes', false, 1024, 'Free', 'Bake Cookies', 'uebung@cbse.st')
