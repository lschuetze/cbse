...
insert into Appointment(id, endDate, notes, personal, startDate, status, title, creator_email) values (4711, 1371022633372+100000, 'testnotes', false, 1371022633372, 'Free', 'Bake Cookies', 'uebung@cbse.st')
